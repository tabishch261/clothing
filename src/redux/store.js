...
const middlewares = [logger]; // Only apply the logger in development, in production we dont apply
// const middlewares = [];
// if (process.env.NODE_ENV === 'development'){ // yarn start (For development we push logger into arr )  - yarn build (For production)
